      ...
      <div class="flex items-center justify-between">
        ...
        >
          ...
          <div class="flex justify-center m-auto mb-5 hidden md:block">
            <UBadge label="Assinatura" variant="subtle" class="relative ml-1" />
          </div>
        </h3>
              ...
              <div class="flex items-center flex-wrap justify-center h-full">
                ...
                >
                  ...
                  >
                    ...
                    de alta qualidade, cuidadosamente escolhidos para atender às
                    suas necessidades. Combinando produtos para o rosto, corpo e
                    cabelo, nossa Box Premium oferece uma experiência completa
                    de cuidados pessoais. Aproveite os benefícios de uma pele
                    radiante e saudável com nossos produtos de esfoliantes
                    suaves. Mime-se com momentos de relaxamento e renovação,
                    enquanto desfruta dos aromas deliciosos e de produtos de
                    beleza a cada mês, permitindo que você experimente novidades
                    e descubra seus favoritos. Aproveite a comodidade de receber
                    tudo em uma única caixa, entregue diretamente na sua porta.
                    Não perca a oportunidade de elevar sua rotina de beleza
                  </p>
                </div>
              </div>
            </UCard>
